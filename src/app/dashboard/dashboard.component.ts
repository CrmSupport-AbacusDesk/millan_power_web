...
export class DashboardComponent implements OnInit {
    ...
    get_counts() 
    {
        ...
        //     this.db.post_rqst({ }, 'master/getUppercounts').subscribe(d => 
        //         {
        //             this.loading_list = false;
        //             console.log(d);
                 
        //             this.user_karigar = d.user_karigar;
        //             this.user_Retailer = d.user_Retailer;
        //             this.pending_redeem_request = d.pending_redeem_request;
